...
if (!empty($_POST))
{
	...
	if(empty($image))
	{
	   $tab["imvide"]="postez une image svp? ";
	   $tab["valid"]=false;
	}else
	     {
			 $upload=true;
	 ...
	 // $bd=new PDO('mysql:host=sql.nsipaie.com;dbname=c3074_nsidb','c3074_cmoussa','NsiData2018');
	  ...
	  catch(exception $e)
	  {
		  die('Erreur:'.$e->getMessage());
		   ...
		   $val=array($tab["nom"],$tab["descr"],$image,$tab["prix"],$tab["cat"]);
		   
		   $insert='INSERT INTO `ingredient`(`Id`, `nom`, `titr`, `im`, `prix`, `categorie`, `dat_inscr_cli`) VALUES(NULL,?,?,?,?,?,Now())';  
    ...
    <ul class=" lien2 nav navbar-nav navbar-right">
      ...
      <section>
         <div class="container-fluid admin">
           <div class="row">
             <h1 style="text-align:center" class="titr-market"><strong>INGREDIENTS</strong> </h1>
              <div class="col-md-8">
  
                   
                   <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    <div class="form-group" >
                    <label for="nom">NOM</label><input type="text" placeholder="NOM" class="form-control" name="nom" id="nom"  value="<?php  echo $tab["nom"];  ?>"/>
                     <p style="color:red; font-style:italic"><?php echo $tab["nomvide"]; ?>  </p>
                     </div>
                     <div class="form-group" >
                     <label>DESCRIPTION</label><input type="text" placeholder="Detail" class="form-control" name="descr"  value="<?php  echo $tab["descr"];  ?>"/>
                     <p style="color:red; font-style:italic"><?php echo $tab["descrvide"]; ?>  </p>
                     </div>
                     <div class="form-group" >
                     <label for="prix">PRIX (en CFA)</label><input type="number" step="250" placeholder="prix par Kilos" class="form-control" name="prix" id="prix"  value="<?php  echo $tab["prix"];  ?>"/>
